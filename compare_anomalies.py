...
def generate_comparison_report():
    ...
    **Anomaly Data:**
    ...
    - Average Heart Rate (last 5 mins): {float(simple_example['hr_rolling_avg']):.1f} bpm if isinstance(simple_example['hr_rolling_avg'], (int, float)) else simple_example['hr_rolling_avg']
    - Previous Night's Deep Sleep: {float(simple_example.get('sleep_deep_minutes', 'N/A')):.0f} minutes if isinstance(simple_example.get('sleep_deep_minutes', 'N/A'), (int, float)) else simple_example.get('sleep_deep_minutes', 'N/A')
    ...
    **Anomaly Data:**
    ...
    - Average Heart Rate (last 5 mins): {float(complex_example['hr_rolling_avg']):.1f} bpm if isinstance(complex_example['hr_rolling_avg'], (int, float)) else complex_example['hr_rolling_avg']
    - Previous Night's Deep Sleep: {float(complex_example.get('sleep_deep_minutes', 'N/A')):.0f} minutes if isinstance(complex_example.get('sleep_deep_minutes', 'N/A'), (int, float)) else complex_example.get('sleep_deep_minutes', 'N/A')
